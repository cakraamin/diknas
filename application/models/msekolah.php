...
class Msekolah extends CI_Model{
	...
	function updateSekolah($id,$thn)
	{
		...
		foreach($kelompok as $dt_kelompok)
		{
			$kel = $kel."-".$dt_kelompok;
		}		
		...
		$data = array(
		    ...
		    'gugus_school'			=> $this->input->post('gugus_school',TRUE),
		    'mbs_school'			=> $this->input->post('mbs_school',TRUE),
		    'kurikulum_school'		=> $this->input->post('kurikulum_school',TRUE),
