                              ...
                              <table class="display static " id="static">
                                ...
                                <thead>
                                  ...
                                  <tr>
                                    ...
                                    <th align="left" width="300">Propinsi</th>
                                ...
                                ?>
                                  ...
                                  <tr>
                                    ...
                                    <td  width="35" ><input type="checkbox" name="check[]" class="chkbox"  id="check<?=$no?>" value="<?=$dt_kueri->id_kabupaten?>"/></td>
                                    ...
                                    <td >          
                                      ...
                                      <span class="tip" >
                                          ...
                                          <a id="<?=$no?>" class="Delete"  name="Band ring" title="Delete Kabupaten" href="<?=base_url()?>masters/hapus_kabupaten/<?=$dt_kueri->id_kabupaten?>"  >
