...
<table class="tabels">
                                ...
                                ?>
                                  ...
                                  <tr>
                                    ...
                                    <td  align="left"><a href="<?php echo base_url(); ?>viewer/detail/<?php echo $viewene; ?>/<?php echo $pecah_kec[1]; ?>"><?php echo $pecah_kec[0]; ?></a></td>
                                    ...
                                    foreach($dt_kueri as $key => $detail_kueri)
                                    {
                                      ...
                                      echo "<td class='".$jum.$key."laki'><a href='".base_url()."viewer/daftar/".$viewene."/".$pecah_kec[1]."/".$key."/1/0'>".$detail_kueri['laki']."</a></td>"; 
                                      echo "<td class='".$jum.$key."peremp'><a href='".base_url()."viewer/daftar/".$viewene."/".$pecah_kec[1]."/".$key."/2/0'>".$detail_kueri['peremp']."</a></td>"; 
