<form action="<?=base_url()?>manajemen/all_paud" method="POST" enctype="multipart/form-data">
...
<div class="topcolumn">
            ...
            <div class="logo"></div>
                            ...
                            <ul  id="shortcut">
                                ...
                                <li> <a href="<?=base_url()?>manajemen/tambah_paud" title="Back To home"> <img src="<?=base_url()?>assets/template/fingers/images/icon/shortcut/add.png" alt="home" width="40px"/><strong>Tambah Data</strong> </a> </li>

                                <li> <a href="<?=base_url()?>manajemen/generate_paud" title="Back To home"> <img src="<?=base_url()?>assets/template/fingers/images/icon/shortcut/generate.png" alt="Generate" width="40px"/><strong>Generate</strong> </a> </li>
                              ...
                              <table class="display static " id="static">
                                ...
                                ?>
                                  ...
                                  <tr>
                                    ...
                                    <td >
                                      <?
                                      $level = ($dt_kueri->user_level == 100)?'Admin PAUD':'Operator PAUD';
                                      echo $level;
                                      ?>
                                    </td>
                                    ...
                                    <td >          
                                      ...
                                      <span class="tip" >
                                          ...
                                          <a  title="Edit" href="<?=base_url()?>manajemen/edit_paud/<?=$dt_kueri->user_id?>" >
                                      ...
                                      <span class="tip" >
                                          ...
                                          <a id="<?=$no?>" class="Delete"  name="Band ring" title="Delete" href="<?=base_url()?>manajemen/hapus_paud/<?=$dt_kueri->user_id?>"  >
