...
<table class="tabels">
                                ...
                                ?>
                                  ...
                                  <tr>
                                    ...
                                    <td  align="left"><?php echo $pecah_nama[0]; ?></td>
                                    ...
                                    foreach($dt_kueri as $key => $detail_kueri)
                                    {
                                      ...
                                      echo "<td class='".$jum.$key."laki'><a href='".base_url()."viewer/daftar/".$viewene."/".$pecah_nama[1]."/".$key."/1/1'>".$detail_kueri['laki']."</a></td>"; 
                                      echo "<td class='".$jum.$key."peremp'><a href='".base_url()."viewer/daftar/".$viewene."/".$pecah_nama[1]."/".$key."/2/1'>".$detail_kueri['peremp']."</a></td>"; 
