                                      ...
                                      <div class="section" id="penyebuts">
                                        ...
                                        <label> Pilihan Penyebut  </label>   
                                          ...
                                          <div>
                                              ...
                                              <input type="radio" name="provider" id="radiop-3" value="3"  class="ck plh"/>

                                              <label for="radiop-3">Jumlah Siswa</label>

                                          </div>

                                          <div>

                                              <input type="radio" name="provider" id="radiop-6" value="6"  class="ck plh"/>

                                              <label for="radiop-6">Jumlah Rombongan Belajar</label>

                                          </div>

                                          <div>

                                              <input type="radio" name="provider" id="radiop-4" value="4"  class="ck plh"/>

                                              <label for="radiop-4">Jumlah Guru Tetap</label>

                                          </div>

                                          <div>

                                              <input type="radio" name="provider" id="radiop-5" value="5"  class="ck plh"/>

                                              <label for="radiop-5">Jumlah Seluruh Guru</label>
