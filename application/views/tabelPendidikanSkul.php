  ...
  function jumlahTotal(id){
    ...
    $('.'+id+'hasil').html(sum);
                              ...
                              <div class="tab_content">                                 
                                <table class="tabels">
                                    <tr>
                                        <td rowspan="2" class="juduls">NO</td><td rowspan="2" class="juduls">NAMA</td><td colspan="2">SLTA</td><td colspan="2">Sarjana</td><td colspan="2">Diploma</td><td colspan="2">Magister</td><td colspan="2">Doktor</td>                                        
                                    </tr>
                                    <tr>
                                        <td>L</td><td>P</td><td>L</td><td>P</td><td>L</td><td>P</td><td>L</td><td>P</td><td>L</td><td>P</td>
                                    </tr>
                                    <?php
                                    $n = 1;
                                    $jum = "jum";  
                                    ...
                                    {                                   
                                      ...
                                      <tr>
                                          ...
                                          foreach($detail as $key => $detail_tingkat)
                                          {
                                            ...
                                            $pecah_pend = explode("-", $key);
                                            /*echo "<td class='".$jum.$key."laki'>".$detail_tingkat['laki']."</td>";
                                            echo "<td class='".$jum.$key."peremp'>".$detail_tingkat['peremp']."</td>";*/
                                            echo "<td class='".$jum.$key."laki'><a href='".base_url()."viewer/daftar/".$viewene."/".$pecah_nama[1]."/".$id."/1/1/".$pecah_pend[1]."'>".$detail_tingkat['laki']."</a></td>";
                                            echo "<td class='".$jum.$key."peremp'><a href='".base_url()."viewer/daftar/".$viewene."/".$pecah_nama[1]."/".$id."/2/1/".$pecah_pend[1]."'>".$detail_tingkat['peremp']."</a></td>";
                                          }
                                          if($n == count($kueri))
                                          {
