...
<div class="topcolumn">
            <div class="logo"></div>
                            <ul  id="shortcut">
                                <li> <a href="<?=base_url()?>masters/umur" title="Back To home"> <img src="<?=base_url()?>assets/template/fingers/images/icon/shortcut/home.png" alt="home" width="40px"/><strong>Daftar</strong> </a> </li>
                            </ul>      
          </div>  
          <div class="clear"></div>          
                    <div class="clear"></div>
                          ...
                          <div id="tab1" class="tab_content"> 
                              <div class="load_page">                        
                                ...
                                <legend><?=$ket?> <span class="small s_color">( <?=$jenis?> )</span></legend>                                                                                                                                                   
                                      ...
                                      <div class="section">
                                      <label> Sertakan Jenjang  </label>
                                      <div>
                                              <?
                                              $jsj = "onChange='ganti()' id='jenis'";                                              
                                              $jenis = (isset($kueri['jenis_umur']) AND $kueri['jenis_umur'] == 0)?FALSE:TRUE;
                                              echo form_checkbox('jenis', '1', $jenis,$jsj);
                                              ?>
                                      <span class="f_help"> Pilih tingkat kelas. </span> 
                                      </div>                                                                            
                                      </div>
                                      <?php $jtingkat = (isset($kueri['jenis_umur']) AND $kueri['jenis_umur'] == 0)?'style="display:none"':''; ?>
                                      <div class="section" id="tingkat" <?php echo $jtingkat; ?>>
