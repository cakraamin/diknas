                              ...
                              <div class="load_page">                                                         
                                ...
                                <legend><?=$ket?> <span class="small s_color">( <?=$jenis?> )</span></legend>                                      
                                      ...
                                      else
                                      {
                                        ?>
                                        <div class="section bilangan">
                                           <label>Rata-rata Nilai UN</label>   
                                           <div>
                                              <input type="text" name="nilai_rata" id="nilai_rata"  class="small" value="<?php echo $rata; ?>"/>
                                          </div>                                            
                                        </div>
                                        <?
                                      }                                      
                                      ?>                                           
                                      <input type="hidden" name="tingkate" value="<?php echo $tingkat; ?>">
