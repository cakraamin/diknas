                    ...
                    <div class="tab_container" >
                          ...
                          <div id="tab1" class="tab_content"> 
                              <div class="load_page">                        
                                ...
                                <div class="formEl_b">  
                                <form id="validation" action="<?=base_url()?>paud/sekolah/<?=$link?>" method="POST" enctype="multipart/form-data"> 
                                <fieldset >
                                <legend><?=$ket?> <span class="small s_color">( <?=$jenis?> )</span></legend>                                                                                                             
                                     ...
                                     <a href="<?=base_url()?>paud/sekolah/sample">Download Sample File Excel</a>
                                </fieldset>
                                </form>
                                </div>
                              </div>  
