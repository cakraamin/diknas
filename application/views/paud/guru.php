<form action="<?=base_url()?>paud/guru/all_guru" method="POST" enctype="multipart/form-data">
...
<div class="topcolumn">
            ...
            <div class="logo"></div>
                            ...
                            <ul  id="shortcut">
                                ...
                                <li> <a href="<?=base_url()?>paud/guru/tambah_guru" title="Back To home"> <img src="<?=base_url()?>assets/template/fingers/images/icon/shortcut/add.png" alt="home" width="40px"/><strong>Tambah</strong> </a> </li>
                                  ...
                                  <tr>
                                    ...
                                    <td >          
                                      ...
                                      <span class="tip" >
                                          ...
                                          <a  title="Edit Guru" href="<?=base_url()?>paud/guru/edit_guru/<?=$dt_kueri->id_guru?>" >
                                      ...
                                      <span class="tip" >
                                          ...
                                          <a id="<?=$no?>" class="Delete"  name="Band ring" title="Delete Guru" href="<?=base_url()?>paud/guru/hapus_guru/<?=$dt_kueri->id_guru?>"  >
